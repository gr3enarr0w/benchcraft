"""Runnable end-to-end demo of dscraft.forecast.
...
`dscraft.forecast.forecast`, backtests it with
`dscraft.forecast.backtest`, and prints the resulting forecast and
...
def build_real_co2_panel() -> pd.DataFrame:
    ...
    means, reshaped into the unique_id/ds/y schema dscraft.forecast
