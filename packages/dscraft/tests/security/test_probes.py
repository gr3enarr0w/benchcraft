...
(`dscraft.core.sandbox.get_default_executor()`), not a mock. On macOS (this
...
from dscraft.security.adapter import Attempt, Finding
from dscraft.security.leaderboard import run_leaderboard
...
def test_default_executor_is_the_real_seatbelt_backend_on_macos():
    ...
    # this project's reference platform (macOS), dscraft.core.sandbox must
