"""Tests for `dscraft.vision.export`: torch.export -> ONNX correctness.

Hermetic: uses `dscraft.vision.model.build_model` (deterministic,
...
`dscraft.automl`'s `.compile()` tests.
"""
