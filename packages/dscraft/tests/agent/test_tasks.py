"""Tests for dscraft.agent.tasks -- the file-manipulation task family.
...
from dscraft.agent.adapter import SandboxedAgentAdapter
...
def test_fail_task_is_genuinely_blocked_by_the_sandbox_not_just_scored_false(
    ...
    the shared dscraft.core.sandbox executor's write-path allowlist actually
...
def test_score_file_task_rejects_non_file_task_spec():
    ...
    from dscraft.agent.adapter import AgentTrajectory, TaskSpec
    from dscraft.core.sandbox import SandboxPolicy, SandboxResult
