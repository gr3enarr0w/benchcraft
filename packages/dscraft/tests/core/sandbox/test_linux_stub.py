"""Tests for dscraft.core.sandbox.linux_stub.LinuxNamespaceSandboxExecutor.
...
from dscraft.core.sandbox.base import SandboxBackendUnavailableError
...
def test_is_available_is_always_false_on_linux_regardless_of_helper_presence(monkeypatch):
    ...
    import dscraft.core.sandbox.linux_stub as linux_stub_module
...
def test_get_default_executor_returns_seatbelt_not_linux_stub_on_this_machine():
    ...
    from dscraft.core.sandbox import SeatbeltSandboxExecutor, get_default_executor
...
def test_get_default_executor_dispatches_to_linux_stub_when_platform_is_linux(monkeypatch):
    """get_default_executor() dispatches to LinuxNamespaceSandboxExecutor whenever platform.system() reports "Linux" -- verified by monkeypatching platform.system() (as referenced directly in dscraft.core.sandbox's own get_default_executor()) so this passes on any host, including this macOS machine."""
    import dscraft.core.sandbox as sandbox_package
