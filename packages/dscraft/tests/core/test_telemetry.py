"""Tests for dscraft.core.telemetry (OTel GenAI semantic-convention helpers, §2.6).

These tests deliberately do not depend on the OpenTelemetry SDK (dscraft.core
