...
aggregating the resulting :class:`~dscraft.security.adapter.Finding`
...
from dscraft.security.adapter import BaseSecurityAdapter, Finding
...
def run_leaderboard(
    ...
    :meth:`~dscraft.security.adapter.BaseSecurityAdapter.run`), so every
