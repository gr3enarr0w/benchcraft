...
profile from a :class:`~dscraft.core.sandbox.base.SandboxPolicy` and invokes
...
#: as a hard guarantee (see :class:`~dscraft.core.sandbox.base.SandboxResult`
...
class SeatbeltSandboxExecutor(BaseSandboxExecutor):
    ...
    **Stricter contract than the original implementation:**
    ...
    - ``SandboxPolicy.allowed_read_paths``/``allowed_write_paths``/
      ...
      :class:`~dscraft.core.sandbox.base.SandboxPolicy`'s own
    ...
    def is_available(self) -> bool:
        ...
        :meth:`~dscraft.core.sandbox.base.BaseSandboxExecutor.is_available`
    ...
    def _classify_denial(
        ...
        :class:`~dscraft.core.sandbox.base.SandboxResult.policy_blocked`
        docstring.
        ...
        try:
            ...
            try:
                ...
                return SandboxResult(
                    ...
                    + "\n[dscraft.core.sandbox] command timed out",
    ...
    def run_callable(
        ...
        **Never pickles ``func`` in this (trusted, host) process.** Since
        ...
        with tempfile.TemporaryDirectory(prefix="dscraft.core-sandbox-") as tmp_dir:
