"""benchcraft-lazygraph: Benchcraft's graph ML module.
...
GCN path in this package -- no parallel implementations exist elsewhere):
    >>> from benchcraft_lazygraph import PyGSparseAdapter, GCN, resolve_device
"""

from benchcraft_lazygraph.gcn import GCN, resolve_device
